    ...
    return (
        ...
        >
            <Form form={form} layout="vertical" onFinish={onFinish}>
                <Form.Item label="商品ID" name="id" rules={[{ required: true, message: '请输入商品ID' }]}>
                ...
                <Form.Item label="货币" name="currency" rules={[{ required: true, message: '请选择货币类型' }]}>
                    <Select
                        placeholder="请选择货币类型"
                ...
                <Form.Item label="计量单位" name="unit" rules={[{ required: true, message: '请选择计量单位' }]}>
                    <Select
                        placeholder="请选择计量单位"
                ...
                <Form.Item label="默认仓库" name="defaultWarehouseId">
                    <Select
                ...
                <Form.Item label="默认仓位" name="defaultPositionId">
                    <TreeSelect
