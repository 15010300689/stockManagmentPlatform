...
function AddPositionModal(props) {
    const { mode, isOpen, onCancel, currentPositionInfo = {}, warehouseList = [], positionTree = [] } = props;
    ...
    useEffect(() => {
        if (mode === "edit" && currentPositionInfo.id) {
            form.setFieldsValue({
                ...
                parentId: currentPositionInfo.parentId,
                ...
                status: currentPositionInfo.status === '1' || currentPositionInfo.status === 1
            });
            setSelectedWarehouse(currentPositionInfo.warehouseId);
        } else {
            form.resetFields();
            form.setFieldsValue({
                status: true
    ...
    }, [mode, isOpen, currentPositionInfo]);
